...
\midrule
 75 & 6.71 & 9 &  0.9 &  0.0 & 22.5 & 15.0 \\
100 & 4.33 & 8 & 11.7 &  0.0 & 30.0 & 20.0 \\
125 & 2.86 & 4 & 27.9 &  8.9 & 37.5 & 25.0 \\
\rowcolor{yellow!18}
\textbf{150} & \textbf{1.62} & \textbf{3} & \textbf{47.7} & \textbf{23.9} & \textbf{45.0} & \textbf{30.0} \\
175 & 1.05 & 3 & 65.4 & 23.9 & 52.5 & 35.0 \\
200 & 0.57 & 2 & 76.4 & 23.9 & 60.0 & 40.0 \\
\bottomrule
\end{tabular}
\end{center}
...
\textbf{MAX = 150} is the sweet spot: 1.62 teams at cap, max 3; separation 48; per-series bound 45 tickets.

\textbf{MAX $\geq$ 175} makes the cap nearly decorative (mean 0.6--1.0 teams); per-series cost climbs to 52--60 tickets, above the 1.5-season heuristic.
