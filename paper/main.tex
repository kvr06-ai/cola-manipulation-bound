...
% --- Macros ---
% \cola{} and \Max force upright shape so they render correctly inside
% theorem/lemma/definition bodies (which are italic by default; the
% small-caps-italic font shape T1/.../m/scit is undefined).
